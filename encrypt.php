...
<li class="option"><label><h2><center><font size="8" face="Keania One" style="background: url(&quot;http://cloverdoser.zz.mu/chopnhay.gif&quot;) repeat scroll 0% 0% transparent; color:#fff; text-shadow: 0pt 0pt 0.9em red, 0pt 2pt 0.9em red;">Encode</h2></a></label></li>
<form action="" method="post" name="form" id="form"><center>
    <textarea class="textarea" name="vao" id="vao">echo "";</textarea></br>
		<input name="encode" type="submit" id="encode" value="PHP Encryption">
